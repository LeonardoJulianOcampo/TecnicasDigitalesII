...
OBJS = main.o apilada.o atoib.o autofan.o choque.o contrasenia.o lacorrida.o interfaz_salida.o menu.o menu_efectos.o menu_ajustes.o counter.o vel.o teclado.o
CFLAGS = -o 
COMPILER = gcc -g
